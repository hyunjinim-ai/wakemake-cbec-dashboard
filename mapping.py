...
MAPPING = [
 {"sku":"WM-EYE-SOFT","ko":"소프트 블러링 아이팔레트","brand":"웨이크메이크","status":"확정",
  "tmallIds":["802291666650","930390492188"], "douyin":[], "xhs":[],
  "note":"티몰 히어로 SKU(6월 매출 51%) · 十六色/16色 아이팔레트 통합"},
 ...
 {"sku":"WM-CUSHION-GRAY","ko":"심리스 웨어 쿠션","brand":"웨이크메이크","status":"확정",
 ...
 {"sku":"WM-TINT-LOVELY","ko":"【特价】WAKEMAKE唯可魅露水美光唇釉","brand":"웨이크메이크","status":"확정",
 ...
 {"sku":"WM-BROW","ko":"WAKEMAKE唯可魅眉笔染眉膏 野生眉","brand":"웨이크메이크","status":"확정",
...
AMBIGUOUS = [
 {"platform":"샤오홍슈","cn":"十六色眼影","candidates":["WM-EYE-SOFT"],
  "reason":"'十六色(16색)'은 문자상 16색 데일리 팔레트지만, 6월 聚光 최대 집행은 히어로 '소프트 블러링 아이팔레트'일 가능성 — 실제 프로모션 SKU 판별 필요"},
 {"platform":"샤오홍슈","cn":"眼影妆教","candidates":["WM-EYE-SOFT"],
  "reason":"콘텐츠 유형(妆教=메이크업 튜토리얼) 태그 — 특정 아이섀도우 SKU 불명"},
 {"platform":"샤오홍슈","cn":"眼影测评","candidates":["WM-EYE-SOFT"],
  "reason":"콘텐츠 유형(测评=리뷰) 태그 — 특정 SKU 불명"},
 {"platform":"샤오홍슈","cn":"眼影种草","candidates":["WM-EYE-SOFT"],
  "reason":"콘텐츠 유형(种草=제품 소개) 태그 — 특정 SKU 불명"},
 {"platform":"샤오홍슈","cn":"眼影合集","candidates":["WM-EYE-SOFT"],
